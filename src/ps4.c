...
void ps4Cmd(ps4_cmd_t cmd) {
  ...
  hidCommand.data[ps4_control_packet_index_small_rumble] = cmd.smallRumble;
  hidCommand.data[ps4_control_packet_index_large_rumble] = cmd.largeRumble;

  hidCommand.data[ps4_control_packet_index_red] = cmd.r;
  hidCommand.data[ps4_control_packet_index_green] = cmd.g;
  hidCommand.data[ps4_control_packet_index_blue] = cmd.b;
...
**
** Description      Sets the Bluetooth MAC address for pairing
**
**
** Returns          void
**
